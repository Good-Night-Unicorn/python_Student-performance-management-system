        ...
        if file_type in ['xlsx', 'xls']:
            ...
            try:
                for row in range(1, rows):
                    ...
                    req_dict['zhuanye'] = row_values[5]
                    req_dict['shouji'] = row_values[6]
...
def xuesheng_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/djangogpkm2/xuesheng/notify',
            #notify_url=''
        )
...
def xuesheng_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/djangogpkm2/admin/dist/index.html#/xuesheng')
