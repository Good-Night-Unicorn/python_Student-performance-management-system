<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开课日期" prop="kaikeriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaikeriqi" 
                type="date"
                :readonly="ro.kaikeriqi"
                placeholder="开课日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaikeriqi" label="开课日期" prop="kaikeriqi">
              <el-input v-model="ruleForm.kaikeriqi" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengleixing = true;
          ...
          if(o=='kaikeriqi'){
            this.ruleForm.kaikeriqi = obj[o];
	    this.ro.kaikeriqi = true;
            continue;
          }
          if(o=='shangkedidian'){
