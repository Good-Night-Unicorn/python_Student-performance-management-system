<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开课日期" prop="kaikeriqi">
          <el-input v-model="ruleForm.kaikeriqi" 
              placeholder="开课日期" clearable  :readonly="ro.kaikeriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开课日期" prop="kaikeriqi">
              <el-input v-model="ruleForm.kaikeriqi" 
